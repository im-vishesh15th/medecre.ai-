...
const VideoCall = () => {
   ...
   const navigte=useNavigate();
    ...
    const myMeeting= async(element)=>{
        ...
        const kitToken = ZegoUIKitPrebuilt.generateKitTokenForTest(appID,serverSecret,roomId,Date.now().toString(),"Vishesh Gupta");
        ...
        zc.joinRoom({
            ...
            scenario: {
             ...
             onReturnToHomeScreenClicked: () => {navigte('/dashboard')}
